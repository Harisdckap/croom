        ...
        const fetchRequirement = async () => {
            try {
                const response = await axios.get(
                    `http://127.0.0.1:8000/api/requirements/${id}`
                );
            ...
            <div className="container mx-auto p-6 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-none w-full lg:w-1/3 mb-6 lg:mb-0">
                        {requirement.photo ? (
                            <img
                                src={`http://127.0.0.1:8000/storage/${requirement.photo}`} // Adjust this based on your actual image path
                            ...
                            <img
                                src="/path/to/profile-icon.png" // Profile icon image URL
                                alt="Profile Icon"
                                className="w-full h-60 object-cover rounded-lg shadow-lg"
                            />
                        )}
                    ...
                    <div className="flex-1">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center text-lg text-gray-600">
                                ...
                                <p>
                                    <strong>Price:</strong> ${requirement.price}
                                </p>
                            </div>
                            <div className="flex items-center text-lg text-gray-600">
                                <FaBed className="mr-2 text-gray-500" />
                                <p>
                                    <strong>Rooms:</strong> {requirement.rooms}
                                </p>
                            </div>
                            <div className="flex items-center text-lg text-gray-600">
                        ...
                        <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-md">
                            ...
                            {Array.isArray(requirement.highlighted_features) &&
                            requirement.highlighted_features.length > 0 ? (
                                <ul className="list-disc list-inside text-gray-700 space-y-2 pl-5">
                                    {requirement.highlighted_features.map(
                                        (feature, index) => (
                                            <li
                                                key={index}
