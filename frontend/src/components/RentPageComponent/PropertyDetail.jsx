...
const PropertyDetail = () => {
    ...
    const fetchProperty = async () => {
        try {
            const response = await axios.get(`http://127.0.0.1:8000/api/property/${id}/${encodeURIComponent(location)}`);
            ...
            >
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    >
                        ...
                        {/* Description Section */}
                        <div className="mt-6">
                            <p className="text-gray-700 text-lg"><strong>Description:</strong> {property.description}</p>
                        </div>
                    </motion.div>
                </div>
            </motion.div>
